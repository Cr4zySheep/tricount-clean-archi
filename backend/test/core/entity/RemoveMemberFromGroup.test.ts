...
describe("Remove a member from a group (entity)", () => {
    ...
    beforeEach(() => {
        testMembers = [new GroupMember(0, "Luc"), new GroupMember(1, "Jessica"), new GroupMember(2, "Pierre")];
      });
    ...
    describe("Happy path", () => {
        test("should remove members to a group when the members are already in the group", async () => {
          ...
          // Assert
          const expectedResult = [new GroupMember(1, "Jessica"), new GroupMember(2, "Pierre")];
